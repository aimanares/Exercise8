...
class CatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $cats = new Cat([ 
            ...
            'age' => Carbon::parse($request->get('date_of_birth'))->diff(Carbon::now())->format('%y years, %m months and %d days')
        ]); 
    ...
    public function update(Request $request, $cat_id)
    {
        ...
        $cats->age = Carbon::parse($request->get('date_of_birth'))->diff(Carbon::now())->format('%y years, %m months and %d days');
